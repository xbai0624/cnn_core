...
void FCLayer::UpdateWeightsAndBias()
{
...
void FCLayer::UpdateWeightsAndBiasGradients()
{
    // after finishing one training sample, update weights and bias
    auto layerType = this->GetType();
...
void FCLayer::UpdateWeightsAndBiasGradientsFC()
{
...
void FCLayer::UpdateWeightsAndBiasFC()
{
    // after finishing one batch, update weights and bias, for FC layer
    // get output from previous layer for current training sample
...
void FCLayer::UpdateWeightsAndBiasGradientsCNN()
{
...
void FCLayer::UpdateWeightsAndBiasCNN()
{
...
void FCLayer::UpdateWeightsAndBiasGradientsPooling()
{
...
void FCLayer::UpdateWeightsAndBiasPooling()
{
...
void FCLayer::SetLearningRate(double l)
{
    // set up learning rate
    __learningRate = l;
}

void FCLayer::SetRegularizationMethod(Regularization r)
{
    // set L1 or L2 regularization
    __regularizationMethod = r;
}

void FCLayer::SetRegularizationParameter(double p)
{
